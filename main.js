        ...
        <div class="book__detail">
          ...
          <span class="book__star-rate">
           ${createBookStars(book.starRate)}
            <span class="gra"> ${book.reviewCount} reviews</span>
          </span>
        </div>
...
const listBasketItems = () => {
  ...
  basketList.forEach((item) => {
    ...
    <div class="basket__item-info">
      ...
      <span class="book__remove" onClick="removeItemBasket(${item.product.id})">Remove from Basket</span>
    </div>
  ...
  basketListEl.innerHTML = basketListHtml
    ? basketListHtml
    : `<li class="basket__item">There is no product in the basket. Add the product to the basket.</li>`;
